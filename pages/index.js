...
export default function Home() {
  return (
    <div style={{ backgroundColor: "#FFFEFC" }} className="">
      <Head>
        {/* HTML Meta Tags */}
        <title> Live Chat & Email Marketing Software - BigRadar.io </title>
        <meta
          name="description"
        ...
        <meta
          itemprop="name"
          content="Live Chat & Email Marketing Software - BigRadar.io"
        />
        <meta
      ...
      <div class="pt-10 px-6 sm:px-12 xl:px-24 2xl:px-60">
        <div class="text-center md:pt-14 pt-10 ">
          <h1 class="text-3xl md:text-5xl lg:px-16 xl:px-24  font-semibold md:leading-snug m-0">
            We Don't Sell ChatBots We Power Up Your Conversions.
          </h1>
      ...
      <div class="px-6 sm:px-12 xl:px-24 2xl:px-60">
        <div
          ...
          class="gap-y-10 mt-20 pt-6 pb-6 md:flex"
        >
          {/* Box 1 */}
          <div class="text-center p-6 lg:p-20">
            ...
            <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
              Chatbot smartly collects specific user inputs and intimate sales
              team in realtime.{" "}
            </p>
            <Link href="/chatbots">
              <h4 style={{ color: "#FDB137" }} class="underline py-8">
                Learn More ChatBot &gt;
              </h4>
            </Link>
          </div>
          ...
          <div class="text-center p-6 lg:p-20">
            ...
            <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
              Hyper-personalise your auto-messages with your customers using
              200+ audience params.{" "}
            </p>
            <Link href="/livechat">
              <h4 style={{ color: "#FDB137" }} class="underline py-8">
          ...
          <div class="text-center p-6 lg:p-20">
            ...
            <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
              Design modern campaigns across platforms like Web, Mobile, In-App
        ...
        <div class="sm:flex sm:pt-2 lg:pt-20">
          ...
          <div class=" pt-8 w-full items-center flex justify-end">
            <div class="">
              <div
                style={{ backgroundColor: "#F9F5F1" }}
                class="p-4 text-center rounded w-36 mb-10 "
              >
          ...
          <div class="sm:pr-8 w-full pt-14 sm:pt-28 xl:pt-36 lg:pt-40 ">
            <h1 style={{ color: "#FDB137" }} class="font-bold text-6xl">
              "
            </h1>
            <h1 class="italic text-2xl lg:text-3xl sm:text-2xl xl:text-4xl xl:w-10/12 font-medium pb-8">
              BigRadar amazingly increased No of leads we get on our platform.
              Almost 40% increase
            </h1>
      ...
      <div class="px-6 sm:px-12 xl:px-24 2xl:px-60">
        <div>
          <h1 class="text-4xl pt-24 font-bold md:pt-44 md:w-5/12">
            Chatbots for Phenomenal Customer Experience
          </h1>
        </div>
        <div class="sm:flex sm:pt-2 lg:pt-10">
          <div class="sm:pr-8 w-full pt-10 sm:pt-28 xl:pt-36 lg:pt-40 ">
            ...
            <h1 class="text-3xl lg:text-3xl sm:text-2xl xl:text-4xl xl:w-10/12 font-semibold">
              No worries, If you’re on vacations
            </h1>
            <p class="w-full lg:text-xl xl:w-10/12 sm:text-sm pt-4 text-lg text-gray-400 font-light">
              BigRadar smart chatbot senses no reply from business and asks
              visitor to input their email even before they leave the website.
              So when you reply it reaches to their inbox.
            </p>
            <h4 style={{ color: "#FDB137" }} class="underline py-8">
              Learn More &gt;
            </h4>
        ...
        <div class="sm:flex sm:py-16 mt-10">
          ...
          <div class=" pb-20 w-full sm:pl-20 sm:pt-28 lg:pt-36 xl:pt-28 pt-12">
            ...
            <h1 class="text-3xl lg:text-3xl xl:text-4xl xl:w-10/12 sm:text-2xl font-semibold">
              Personalised Chatbot Experience for every customer
            </h1>
            <p class="w-full sm:text-sm lg:text-xl xl:w-10/12 py-4 text-lg text-gray-400 font-light">
              BigRadar provides a single window to your customers so the don’t
              have to look around on the website for basic info like{" "}
              <span class="underline">track my order</span>, last 5 payments
              etc.
            </p>
            <h4 style={{ color: "#FDB137" }} class="underline py-8">
              Learn More &gt;
      ...
      <div class="px-6 sm:px-12 xl:px-24 2xl:px-60">
        <div class="sm:flex sm:pt-2 lg:pt-10">
          <div class="sm:pr-8 w-full sm:pt-28 xl:pt-36 lg:pt-40 ">
            ...
            <p class="w-full lg:text-xl xl:w-10/12 sm:text-sm pt-4 text-lg text-gray-400 font-light">
              Specially apps in our chatbot allows you to configure the lead
              qualification process as per your business needs.
            </p>
            <h4 style={{ color: "#FDB137" }} class="underline py-8">
              Learn More &gt;
            </h4>
        ...
        <div class=" pb-20 w-full sm:pl-8 sm:pt-28 lg:pt-36 xl:pt-48 pt-4 ">
          <div class="xl:w-10/12">
            <h1 class="text-3xl lg:text-3xl xl:text-4xl md:w-8/12 xl:w-10/12 sm:text-2xl font-semibold">
              You Don’t Only Need a Chat Widget to Connect With Your Customers
            </h1>
              ...
              >
                <div class="flex flex-nowrap xl:ml-32 mt-10 gap-x-4 ">
                  ...
                  <div class="inline-block">
                    <div
                      style={{ backgroundColor: "#F9F5F1" }}
                      class="w-96 max-w-lg h-full overflow-hidden rounded-lg transition-shadow duration-300 ease-in-out p-6"
                    >
                      <h4 class="text-xl font-medium pb-2">Engage</h4>
                      <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
                        Delight your customers first smart auto-messages to
                  ...
                  <div class="inline-block">
                    <div
                      style={{ backgroundColor: "#F9F5F1" }}
                      class="w-96 h-full overflow-hidden rounded-lg transition-shadow duration-300 ease-in-out p-6"
                    >
                      <h4 class="text-xl font-medium pb-2">Qualify</h4>
                      <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
                        Chatbot asks very specific questions to qualify the
                        leads. Fully-automated.{" "}
                      </p>
                      <div class="py-6">
                  ...
                  <div class="inline-block">
                    ...
                    >
                      ...
                      <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
                        Offer your products with the messaging and close more
                        deals faster.
                      </p>
                      <div class="py-6">
                  ...
                  <div class="inline-block">
                    ...
                    >
                      ...
                      <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
                        For e-commerce stores, it's 24x7 automated support desk
                        to retain your customers like never before.
                      </p>
                      <div class="py-6">
      ...
      <div
        style={{ backgroundColor: "#F9F5F1" }}
        class="p-8 md:py-14 md:px-14 lg:py-20 lg:px-20"
      >
