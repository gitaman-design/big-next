...
export default function Pricing() {
  return (
    <div style={{ backgroundColor: "#FFFEFC" }} className="">
      <Head>
        {/* HTML Meta Tags */}
        <title> Pricing - BigRadar.io </title>
        <meta
          name="description"
        ...
        <meta itemprop="name" content="Pricing - BigRadar.io" />
        <meta
        ...
        <meta property="og:title" content="Pricing - BigRadar.io" />
        <meta
        ...
        <meta name="twitter:title" content="Pricing - BigRadar.io" />
        <meta
        ...
        <div class="pt-10 grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-3 md:gap-16 lg:gap-4 xl:gap-16">
          ...
          >
            ...
            <div class="flex items-center pt-4">
              ...
              <h3
                style={{ color: "#646464" }}
                class="text-lg font-light pl-4 m-0"
              >
            ...
            <div class="flex items-center pt-4">
              ...
              <h3
                style={{ color: "#646464" }}
                class="text-lg font-light pl-4 pt-2"
              >
          ...
          >
            <div class="bg-black py-10 justify-center">
              ...
              <div class="text-center mt-2">
                ...
                <p class="text-white text-xs m-1">
                  $39/per additional member per month
                </p>
              </div>
          ...
          >
            <div class="bg-black py-10 justify-center">
              ...
              <div class="text-center mt-2">
                <h1 class="font-semibold text-white text-2xl m-0">
                  Custom Pricing
                </h1>
              </div>
            ...
            <div class="pl-4 w-full pr-4 pt-10 pb-0 flex justify-center">
              <button
                class="w-48 h-12 border-black border rounded text-black hover:bg-black hover:text-white text-base"
