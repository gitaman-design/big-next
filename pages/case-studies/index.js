...
export default function CaseStudy() {
  return (
    ...
    {/* Home Banner */}
      ...
      <div class="pt-10 ">
        <div>
                <h5 class="text-gray-400 font-light text-lg">Our customer’s stories</h5>
        ...
        <div style={{backgroundColor: '#F9F5F1'}} class="mt-10 p-6 lg:p-10 rounded md:flex">

              <div class="md:w-6/12 md:pt-6 xl:pr-20 xl:pt-20">
                  <div class="w-20 mb-6">
                        <Image  src={client5} alt="flexi-spaces" />
                  </div>
                        <h2 class="text-xl xl:text-2xl">How FlexiSpaces uses BigRadar to acquire new customers</h2>
                        <p class="xl:text-lg">FlexiSpaces.com is a dynamic startup in India which is disrupting the traditional capital 
                        intensive office spaces. They operate like a AirBnb like model where office space...</p>
                        <Link href="/case-studies/flexispaces">
                            <h4 class="underline text-base xl:text-lg xl:mt-8">Read Case Study ></h4>
                        </Link>
                    </div>
         ...
         <div style={{backgroundColor: '#F9F5F1'}} class="mt-10 lg:p-10 p-6 rounded md:flex">
              ...
              <div class="md:w-6/12 md:pl-4 md:pt-6 xl:pl-10 xl:pt-20 pt-12">
                  <div class="w-52 mb-6">
                        ...
                        <h2 class="text-xl xl:text-2xl">All India Chess Federation giving support to their 
                        members with new AI and conversational based technology.</h2>
                        <p class="xl:text-lg">The All India Chess Federation (AICF) is central administrative body for the game of chess in India. Founded in 1951, 
                        the federation is affiliated to Fédération Internationale des Échecs (FIDE),</p>
                        <Link href="/case-studies/aicf">
                            <h4 class="underline text-base xl:text-lg xl:mt-8">Read Case Study ></h4>
                        </Link>
                    </div>
