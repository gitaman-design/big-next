    ...
    {/* Home Banner */}
      ...
      <div class="pt-10 px-6 sm:px-12 xl:px-24 2xl:px-60">
        <div>
            <div class="md:flex">
                    ...
                    <div class="w-full lg:pt-24 xl:pt-32s sm:w-2/4 py-2 sm:py-2 md:pl-8" >
                        <h5 class="text-gray-400 font-light py-4 text-lg">Live Chat Software for Website / Mobile App</h5>
                        ...
                        <p class=" w-10/12 text-lg xl:w-3/4 text-gray-400 font-light" >
                            BigRadar's Modern chat experience make the customers 
                            feel like a pro support, even if you're away.
                        </p>
                        { /* Enter Email field */}
                        ...
                        <a href="https://app.bigradar.io/register/" target="_blank" rel="noreferrer">
                            <button type="submit" class="w-full h-full bg-black text-white hover:bg-gray-800" >
                                Signup Now
                            </button> 
                        </a>
                        </div>
        ...
        <div class="">
                    ...
                    <div class="w-full lg:pt-36 xl:pt-32 pt-20 sm:py-2 md:pt-32" >
                        ...
                        <p class="lg:py-4 py-4 w-full text-lg xl:w-3/4 text-gray-400 font-light" >
                            BigRadar brings everything you need to know about the person visiting your website.
                            While responding you'll know.
                        </p>

                        <ul class="list-disc list-inside text-lg font-light text-gray-400">
                            <li>
                                Location of the visitor (New York, United States)
                            </li>
                            <li class="pt-2">
                                From which page the chat was started.
                            </li>
                            <li class="pt-2">
                                First time visitor, or returning back.
                            </li>
                            <li class="pt-2">
        ...
        { /* hero image start */}
          ...
          <div class= "px-6 sm:px-12 xl:px-24 2xl:px-60">
            ...
            <div class="md:flex pt-32">
                    ...
                    <div class="w-full lg:pt-24 md:pl-8 md:pt-20 xl:pt-60 sm:w-2/4 py-2" >
                        ...
                        Our live chat mobile app make it easy for you to ditch your desktop and get 
                        the notification of new visitors on your mobile app on iOS and Android devices. 
                        </p>
                    </div>
                    { /* Hero text Ends */}
                </div>
          ...
          <div class="px-6 sm:px-12 xl:px-24 2xl:px-60">
            <div style={{backgroundColor: '#F9F5F1'}} class="gap-y-10 lg:gap-y-6 mt-20 pt-6 pb-6 md:flex md:flex-wrap">
                {/* Box 1 */}
                <div class="text-center p-6 lg:p-20 md:w-80  lg:w-6/12">
                    ...
                    <p style={{color: '#8E8C8C', fontWeight: 'normal'}}>Yep, you don't need to write the whole messages 
                    again and again, just type /refund and the auto reply of refund message will be typed on your screen. </p>
                ...
                <div class="text-center p-6 lg:p-20 md:w-80  lg:w-6/12">
                    ...
                    <p style={{color: '#8E8C8C', fontWeight: 'normal'}}>No more oops, you can customise BigRadar data according 
                    to your business needs. Create as much as custom fields to make it awesome. All inputs like Text, List, Date etc. </p>
                    {/* <h4 style={{color: '#FDB137'}} class="underline py-8">Learn More Messaging &gt;</h4> */}
                </div>
                {/* Box 3 */}
                <div class="text-center p-6 lg:p-20 md:w-80 lg:w-6/12">
                    <Image class="w-14 m-auto" src={offline} alt="icon" />
                    <h4 class="text-xl font-medium pt-6 pb-2">Offline: Auto response</h4>
                    <p style={{color: '#8E8C8C', fontWeight: 'normal'}}>You don't have to be online 24 hrs, BigRadar amazing asks your 
                    visitors to drop their contact information while you are resting on your bed, so you can get up and respond to 
                    them conveniently. No hurries 🙂</p>
                ...
                <div class="text-center p-6 lg:p-20 md:w-80 lg:w-6/12">
                    ...
                    <p style={{color: '#8E8C8C', fontWeight: 'normal'}}>To make your conversations more human, BigRadar supports inputs like 
                    GIFs, Images, Documents, Emoji's. </p>
                    {/* <h4 style={{color: '#FDB137'}} class="underline py-8">Learn More Engagement &gt;</h4> */}
                </div>
            </div>
        </div>
