...
export default function LiveChat() {
  return (
    ...
    >
      <Head>
        {/* HTML Meta Tags */}
        <title> ChatBots - BigRadar.io </title>
        <meta
          name="description"
        ...
        <meta itemprop="name" content="ChatBots - BigRadar.io" />
        <meta
        ...
        <meta property="og:title" content="ChatBots - BigRadar.io" />
        <meta
        ...
        <meta name="twitter:title" content="ChatBots - BigRadar.io" />
        <meta
        ...
        <div>
          <div>
            ...
            <p class="w-10/12 text-lg xl:w-3/4 text-gray-400 font-light">
              BigRadar's Chatbot is built for scale, it doesn't annoy your
              visitors but act like more human. It qualifies lead for your sales
              team on the other hand it also provide awesome support to your
              customers
            </p>
        ...
        <div class="">
          ...
          <div class="gap-y-10 pb-6 md:flex">
            ...
            <div class="text-center p-6 lg:p-20">
              ...
              <p style={{ color: "#8E8C8C", fontWeight: "normal" }}>
                4.1 Stars average customer satisfaction
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        <div class="md:flex md:pt-24 lg:pt-36 ">
          ...
          <div class="w-full sm:w-2/4 pt-24 md:pt-0 xl:w-2/4 flex justify-start">
            <Image class="w-full xl:w-11/12" src={botEdit} alt="Hero" />
          </div>
          {/* hero image end */}
          ...
          <div class="w-full lg:pt-24 md:pl-12 md:pt-20 xl:pt-48 sm:w-2/4 py-4 md:pt-28 lg:pt-52 ">
            ...
            <p class="lg:py-4 py-4 w-10/12 text-lg xl:w-3/4 text-gray-400 font-light">
              It is super-easy to config your chatbots, as easy as drafting a
              document.
            </p>
          </div>
          {/* Hero text Ends */}
      ...
      <div>
        <div class="md:flex xl:pt-36">
          ...
          <div class="w-full lg:pt-24 xl:pt-32 sm:w-2/4 py-2 sm:py-2 md:pt-36 lg:pt-52">
            ...
            <p class="lg:py-4 py-4 w-10/12 text-lg xl:w-3/4 text-gray-400 font-light">
              Optimisation is the key of successful online businesses. With our
              extensive reporting, measure what's performing best and what's
              not. Accordingly, improve the bots. Your customer's will love such
              improvements.
            </p>
          </div>
          {/* Hero text Ends */}
          ...
          <div class="w-full sm:w-2/4 pt-4 xl:w-2/4 flex justify-end">
            <Image class="w-full xl:w-11/12" src={insights} alt="Hero" />
          </div>
          {/* hero image end */}
        </div>
      </div>
