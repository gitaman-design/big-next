        ...
        <div class="md:pt-24 lg:pt-40 xl:pt-72 pt-16 lg:flex lg:flex-wrap">
                ...
                <div class="md:pt-20 md:w-full lg:pt-72 lg:pl-4 lg:w-5/12">
                        <p class="lg:py-4 pt-4 w-10/12 text-lg xl:w-3/4 text-gray-400 font-light" >
                            ...
                            automatically sends messages to their email where they can continue the conversation.
                ...
                <div class="pt-16 md:pt-20 md:w-10/12 lg:w-full lg:pt-0 lg:flex">
                    <div>
                        <Image class="w-full lg:w-11/12 xl:w-full pt-10" src={conversationReturn} alt="widget" />
                    </div>
                    <div class="lg:pt-40 lg:pl-20">
                        ...
                        <p class="lg:py-4 pt-4 w-10/12 text-lg xl:w-3/4 text-gray-400 font-light" >
                            When your customer goes back to your website, they’ll be able to pick up the 
                            conversation in the live chat widget there too.
                        </p>
                        <p class="lg:py-4 pt-4 w-10/12 text-lg xl:w-3/4 text-gray-400 font-light">
